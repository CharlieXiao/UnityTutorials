...
namespace Basics_23
{
    public class FrameRateCounter : MonoBehaviour
    {
        ...
        private float sampleDuration = 1.0f;
        ...
        private void UpdateText()
        {
            switch (displayMode)
            {
                case DisplayMode.FPS:
                    display.SetText(textFPSTemplate,1.0f/m_BestDuration,m_FrameCount/m_Duration,1.0f/m_WorstDuration);
                    break;
                case DisplayMode.MS:
                    display.SetText(textMSTemplate,1000.0f * m_BestDuration,1000.0f * m_Duration/m_FrameCount,1000.0f * m_WorstDuration);
                    break;
            }
        }
